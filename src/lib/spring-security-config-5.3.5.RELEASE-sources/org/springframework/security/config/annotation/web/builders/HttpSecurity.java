...
public final class HttpSecurity extends
	...
	protected DefaultSecurityFilterChain performBuild() {
		// httpSecurity的performBuild将自身所有的filter组成一个DefaultSecurityFilterChain返回
	...
	/*
	 * Spring Security默认的拦截器有AFilter，BFilter和CFilter，我们添加了MBFilter和DFilter
	 * 1. 我们手动添加的filter首先会放在系统默认filter前，所以顺序为MBFilter-DFilter-AFilter-BFilter-CFilter
	 * 2. 经过排序，变成了AFilter-MBFilter-BFilter-CFilter-DFilter
	 */
